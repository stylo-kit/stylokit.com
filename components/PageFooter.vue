<template>
  <footer class="flex flex-row justify-between items-center flex-wrap w-full gap-6">
    <div class="flex flex-row w-auto text-zing-500 body-2">
      © 2025 Stylokit. All rights reserved
    </div>
