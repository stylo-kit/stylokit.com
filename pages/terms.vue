    ...
    <div class="max-w-[768px] mx-auto flex flex-col gap-[48px]">
      <div class="flex flex-col justify-center items-center gap-[16px]">
        ...
        <p class="body text-zing-400 text-center max-w-[640px]">
          Welcome to Stylokit! By accessing our website and using our services,
      ...
      <article
        class="prose prose-invert prose-sm max-w-[720px] prose-h4:heading-6 prose-h4:text-white prose-p:body-2 prose-p:text-zing-400"
      >
