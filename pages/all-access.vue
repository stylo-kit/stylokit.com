...
const { data: plans } = await useAPI<{data: Plan[]}>('/plans');
const features = [
  {
    title: "All products",
...
<template>
  <main class="flex flex-col gap-[32px] px-[32px]">
    <section class="flex flex-col justify-center gap-[56px] pt-[64px] pb-[32px]">
      <div class="flex flex-col items-center self-center max-w-[560px] gap-[32px]">
